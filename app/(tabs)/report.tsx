    ...
    >
      ...
      {status === "lost" && (
        <View style={styles.comicPanel}>
          <Text style={[styles.label, { color: "#FF6B6B" }]}>
            REWARD OFFERED (OPTIONAL)
          </Text>
          <TextInput
            style={[
              styles.input,
              { borderColor: "#FF9F43", backgroundColor: "#241A14" },
            ]}
...
const styles = StyleSheet.create({
  ...
  activeLostButton: { backgroundColor: "#FF6B6B" },
  activeFoundButton: { backgroundColor: "#4CAF50" },
  toggleButtonText: {
    color: "#fff",
    fontWeight: "900",
    fontSize: 16,
  ...
  checkboxRowActive: { backgroundColor: "#241A14", borderColor: "#FF9F43" },
  checkboxBox: {
    width: 20,
    height: 20,
    borderWidth: 1,
  ...
  checkboxBoxActive: { borderColor: "#000", backgroundColor: "#2DD4BF" },
  ...
  checkboxLabelTextActive: { color: "#FF9F43" },
  input: {
    backgroundColor: "#1E1E1E",
    color: "#F5F5F5",
    padding: 14,
  ...
  resolvedAddressValue: { color: "#F5F5F5", fontSize: 13, fontWeight: "700" },
