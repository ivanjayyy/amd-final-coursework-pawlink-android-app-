...
const styles = StyleSheet.create({
  ...
  lostBorder: { borderLeftWidth: 8, borderLeftColor: "#FF6B6B" },
  foundBorder: { borderLeftWidth: 8, borderLeftColor: "#4CAF50" },
  cardHeaderRow: {
    flexDirection: "row",
    justifyContent: "space-between",
    marginBottom: 6,
  },
  cardStatusLabel: { color: "#FF9F43", fontWeight: "900", fontSize: 11 },
  ...
  actionPrompt: { color: "#2DD4BF", fontSize: 11, fontWeight: "900" },
});
